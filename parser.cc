...
#line 80 "parser.yy" // lalr1.cc:412
...
#line 75 "parser.yy" // lalr1.cc:614
...
#line 76 "parser.yy" // lalr1.cc:614
        { delete (yysym.value.calcnode); }
...
#line 76 "parser.yy" // lalr1.cc:614
        { delete (yysym.value.calcnode); }
#line 469 "parser.cc" // lalr1.cc:614
        break;
  ...
  Parser::parse ()
  {
    ...
    #line 43 "parser.yy" // lalr1.cc:741
{
    // initialize the initial location object
    yyla.location.begin.filename = yyla.location.end.filename = &driver.streamname;
}

#line 607 "parser.cc" // lalr1.cc:741
...
#line 107 "parser.yy" // lalr1.cc:859
    {
		   ...
		   error(yylhs.location, std::string("Unknown variable \"") + *(yystack_[0].value.stringVal) + "\"");
...
#undef YYCASE_
  ...
  Parser::yyrline_[] =
  {
       0,    97,    97,   101,   106,   119,   123,   127,   132,   136,
     141,   145,   149,   154,   158,   162,   166,   171,   175,   179,
     184,   189,   198,   199,   200,   201,   202,   203,   204,   208,
     212
  };
...
#line 219 "parser.yy" // lalr1.cc:1168
 /*** Additional Code ***/
